...
fn ttest_one_sample_json() {
    let out = cmd()
        .args([
            "ttest", "--kind", "one", "--col", "value", "--mu", "5.0", "--format", "json",
        ])
        .write_stdin("value\n5.1\n4.9\n6.2\n5.5\n5.0\n4.8\n6.1\n5.3\n5.7\n4.95\n")
        .assert()
        .success()
...
fn ttest_one_sample_greater() {
    let out = cmd()
        .args([
            "ttest", "--kind", "one", "--col", "value", "--mu", "5.0", "--alt", "greater",
            "--format", "json",
        ])
        .write_stdin("value\n5.1\n4.9\n6.2\n5.5\n5.0\n4.8\n6.1\n5.3\n5.7\n4.95\n")
        .assert()
...
fn ttest_one_sample_less() {
    let out = cmd()
        .args([
            "ttest", "--kind", "one", "--col", "value", "--mu", "5.0", "--alt", "less", "--format",
            "json",
        ])
        .write_stdin("value\n5.1\n4.9\n6.2\n5.5\n5.0\n4.8\n6.1\n5.3\n5.7\n4.95\n")
        .assert()
...
fn ttest_one_sample_table_output() {
    cmd()
        .args([
            "ttest", "--kind", "one", "--col", "value", "--mu", "5.0", "--format", "table",
        ])
        .write_stdin("value\n5.1\n4.9\n6.2\n5.5\n5.0\n")
        .assert()
        .success()
...
fn ttest_two_sample_welch_json() {
    let out = cmd()
        .args([
            "ttest", "--kind", "two", "--col", "0", "--col2", "1", "--format", "json",
        ])
        .write_stdin("a,b\n2,1\n4,2\n4,3\n4,3.5\n5,4\n5,4\n7,5\n9,8\n")
        .assert()
        .success()
...
fn ttest_two_sample_pooled() {
    let out = cmd()
        .args([
            "ttest", "--kind", "two", "--col", "a", "--col2", "b", "--var", "pooled", "--format",
            "json",
        ])
        .write_stdin("a,b\n2,1\n4,2\n4,3\n4,3.5\n5,4\n5,4\n7,5\n9,8\n")
        .assert()
...
fn ttest_paired_rejects_null() {
    ...
    cmd()
        .args([
            "ttest", "--kind", "paired", "--col", "before", "--col2", "after", "--format", "json",
        ])
...
fn ttest_json_schema_complete() {
    let out = cmd()
        .args([
            "ttest", "--kind", "one", "--col", "v", "--mu", "0", "--format", "json",
        ])
        .write_stdin("v\n1\n2\n3\n4\n5\n")
        .assert()
        .success()
